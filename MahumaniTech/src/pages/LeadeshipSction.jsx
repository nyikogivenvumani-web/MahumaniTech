        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#f7f9fd] rounded-3xl border border-slate-200 p-8 space-y-6 flex flex-col justify-between hover:border-slate-300 transition-all">
            <div className="space-y-4">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Thomas has extensive local experience in Information Technology, Hosting, Virtualization, Infrastructure Support, Security, Disaster Recovery, Servers, Operating Systems, and Microsoft Exchange over 7 years[cite: 3].
              </p>
            </div>
            ...
            <div className="pt-6 border-t border-slate-200/80 space-y-2">
              ...
              <ul className="text-xs text-slate-700 space-y-1 font-medium">
                <li className="flex items-center gap-2">
                  ...
                  <span>BSc (Computer Systems) – Heriot-Watt University (Edinburgh, UK)[cite: 3]</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-900"></span>
                  <span>BTEC HND IT – London School of Business and Management[cite: 3]</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-900"></span>
                  <span>International Diploma in Computer Studies – CTI College[cite: 3]</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-[#f7f9fd] rounded-3xl border border-slate-200 p-8 space-y-6 flex flex-col justify-between hover:border-slate-300 transition-all">
            <div className="space-y-4">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Jamela brings over 4 years of professional experience in Sales and Marketing[cite: 3]. She drives strategic client outreach, brand positioning, and enterprise account growth across the Southern African development region[cite: 2, 3].
              </p>
            </div>
            ...
            <div className="pt-6 border-t border-slate-200/80 space-y-2">
              ...
              <ul className="text-xs text-slate-700 space-y-1 font-medium">
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-900"></span>
                  <span>National Diploma – Central Johannesburg College[cite: 3]</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-900"></span>
                  <span>Bachelor's Candidate in Social Work – UNISA[cite: 3]</span>
                </li>
              </ul>
            </div>
          </div>
